      ...
      <Tailwind>
        <Body className="bg-white font-sans">
          <Container className="mx-auto py-12 px-4 max-w-xl">
            <Text className="text-2xl font-bold text-black">OpenBSD Device Support Database</Text>
            ...
            <div className="bg-yellow-50 border border-solid border-yellow-200 rounded-md p-4 mt-6">
              <Text className="text-sm text-yellow-800 m-0">
                ...
                anyone. OpenBSD Device Support Database will never ask for your password via email.
              </Text>
            </div>
          </Container>
        </Body>
